...
- 👑 **조장 뽑기** — 다 뽑고 나면 버튼 하나로 조마다 한 명씩. 왕관이 조원들 사이를 돌다가 멈추고, **확정되는 순간 왕관이 툭 얹히며 이름표에서 링이 퍼지고 반짝이·금색 종이가 날린다.** 다시 누르면 다시 뽑고, 그 사람이 조를 옮기거나 자리를 바꾸면 해당 조의 조장은 자동으로 무효가 된다. 결과 복사에도 👑 로 함께 나간다.
...
- 조장은 항상 그 조 소속 · 빈 조는 조장 없음 · 이동/교환/제외 시 해당 조장만 무효 · 600회 반복 시 조원 3명이 고르게 조장
